...
RELATIVE_RETURN_FULL_SCALE_PCT = float(os.environ.get("RELATIVE_RETURN_FULL_SCALE_PCT", 10.0))
VOLUME_CHANGE_FULL_SCALE_PCT = float(os.environ.get("VOLUME_CHANGE_FULL_SCALE_PCT", 50.0))
