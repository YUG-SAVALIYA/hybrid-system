...
Calculates deterministic structural transition scores for industries.
"""
...
class FundamentalIndustryTransitionScoreService:
    ...
    def calculate_transition_scores(self, run_id: str) -> None:
        ...
        for ind in industries:
            calc_details = copy.deepcopy(ind.calculation_details or {})
            ...
            ind.calculation_details = calc_details
